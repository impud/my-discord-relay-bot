...
# === ТВОИ НАСТРОЙКИ ===
DISCORD_TOKEN = "MTM5OTczNzgwMjMzMzA5NDA0MA.GxuXu0.2R97Do2xcZOxarrPTcYpUTq25nKW4jfp3DuXlM"
TELEGRAM_BOT_TOKEN = "8420367030:AAG045mi3OyNV7OoU0Bz9macq7o2xXw4HUY"
TELEGRAM_CHAT_ID = "-1002749231026"  # Пример: -1001234567890 или @channelusername
ALLOWED_THREAD_ID = "1399728689561993261"  # Пример: "1399728689561993261"
...
def send_text_to_telegram(text):
    ...
    if not response.ok:
        print("❌ Ошибка при отправке текста в Telegram:", response.text)
